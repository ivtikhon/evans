...
(define (domain EC2)
  ...
  (:predicates
    ...
    ;; dependencies
    (requires-in-running ?inst1 - instance ?obj1 - object) ;; instance is required by object, i.e. object depends on running instance
    (requires-in-created ?inst1 - instance ?obj1 - object)
    (requires-vol-attached ?vol1 - volume ?obj1 - object)  ;; volume is required by object
    (requires-fs-mounted ?fs1 - filesystem ?obj1 - object)  ;; file system is required by object
    (requires-app-running ?app1 - application ?obj1 - object)  ;; application is required by object
    (requires-dir-exist ?dir1 - directory ?obj1 - object)  ;; directory is required by object
    (requires-fl-exist ?fl1 - file ?obj1 - object) ;; file is required by object
  )
...
;        (imply (requires-in-running ?inst1 ?appn)
    ...
    :precondition (and
      ...
      (forall (?dir1 - directory)
        (forall (?fs1 - filesystem)
          (imply (and (requires-fs-mounted ?fs1 ?dir1)(requires-dir-exist ?dir1 ?app1))
    ...
    :precondition (and
      ...
      (forall (?appn - application)
        (forall (?instn - instance)
          (imply (and (requires-in-running ?instn ?appn) (requires-app-running ?appn ?app1))
      ...
      (forall (?fl1 - file)
        (forall (?dir1 - directory)
          (imply (and (requires-dir-exist ?dir1 ?fl1)(requires-fl-exist ?fl1 ?app1))
